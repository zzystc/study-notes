...
![img](https://s.poetries.work/gitee/2020/07/7.png) ![img](https://s.poetries.work/gitee/2020/07/8.png) ![img](https://s.poetries.work/gitee/2020/07/9.png) ![img](https://s.poetries.work/gitee/2020/07/10.png) ![img](https://s.poetries.work/gitee/2020/07/11.png) ![img](https://s.poetries.work/gitee/2020/07/12.png) ![img](https://s.poetries.work/gitee/2020/07/13.png) ![img](https://s.poetries.work/gitee/2020/07/14.png) ![img](https://s.poetries.work/gitee/2020/07/15.png) ![img](https://s.poetries.work/gitee/2020/07/16.png)
...
![img](https://s.poetries.work/gitee/2020/09/101.png)
...
#### [#](https://interview2.poetries.top/docs/base.html#_1-你觉得jquery或zepto源码有哪些写的好的地方)1 你觉得jQuery或zepto源码有哪些写的好的地方
...
#### [#](https://interview2.poetries.top/docs/base.html#_17-jquery对象的特点)17 jQuery对象的特点
...
#### [#](https://interview2.poetries.top/docs/base.html#_1-什么是bootstrap-以及为什么要使用bootstrap)1 什么是Bootstrap？以及为什么要使用Bootstrap？

>   `Bootstrap` 是一个用于快速开发 `Web`应用程序和网站的前端框架。`Bootstrap`是基于 `HTML`、`CSS`、`JAVASCRIPT` 的

-   `Bootstrap`具有移动设备优先、浏览器支持良好、容易上手、响应式设计等优点，所以`Bootstrap`被广泛应用

#### [#](https://interview2.poetries.top/docs/base.html#_2-使用bootstrap时-要声明的文档类型是什么-以及为什么要这样声明)2 使用Bootstrap时，要声明的文档类型是什么？以及为什么要这样声明？
...
#### [#](https://interview2.poetries.top/docs/base.html#_3-什么是bootstrap网格系统)3 什么是Bootstrap网格系统
...
#### [#](https://interview2.poetries.top/docs/base.html#_5-对于各类尺寸的设备-bootstrap设置的class前缀分别是什么)5 对于各类尺寸的设备，Bootstrap设置的class前缀分别是什么
...
#### [#](https://interview2.poetries.top/docs/base.html#_8-用bootstrap-如何设置文字的对齐方式)8 用Bootstrap，如何设置文字的对齐方式？

-   `class="text-center"` 设置居中文本
-   `class="text-right"` 设置向右对齐文本
-   `class="text-left"` 设置向左对齐文本

#### [#](https://interview2.poetries.top/docs/base.html#_9-bootstrap如何设置响应式表格)9 Bootstrap如何设置响应式表格？

>   增加`class="table-responsive"`

#### [#](https://interview2.poetries.top/docs/base.html#_10-使用bootstrap创建垂直表单的基本步骤)10 使用Bootstrap创建垂直表单的基本步骤？

-   （1）向父`<form>`元素添加`role="form"`；
-   （2）把标签和控件放在一个带有`class="form-group"`的`<div>`中，这是获取最佳间距所必需的；
-   （3）向所有的文本元素`<input>`、`<textarea>`、`<select>`添加`class="form-control"`

#### [#](https://interview2.poetries.top/docs/base.html#_11-使用bootstrap创建水平表单的基本步骤)11 使用Bootstrap创建水平表单的基本步骤？

-   （1）向父`<form>`元素添加`class="form-horizontal"`；
-   （2）把标签和控件放在一个带有`class="form-group"`的`<div>`中；
-   （3）向标签添加`class="control-label"`。

#### [#](https://interview2.poetries.top/docs/base.html#_12-使用bootstrap如何创建表单控件的帮助文本)12 使用Bootstrap如何创建表单控件的帮助文本？

>   增加`class="help-block"`的`span`标签或`p`标签。

#### [#](https://interview2.poetries.top/docs/base.html#_13-使用bootstrap激活或禁用按钮要如何操作)13 使用Bootstrap激活或禁用按钮要如何操作？

-   激活按钮：给按钮增加`.active`的`class`
-   禁用按钮：给按钮增加`disabled="disabled"`的属性

#### [#](https://interview2.poetries.top/docs/base.html#_14-bootstrap有哪些关于的class)14 Bootstrap有哪些关于![img]()的class？
...
#### [#](https://interview2.poetries.top/docs/base.html#_15-bootstrap中有关元素浮动及清除浮动的class)15 Bootstrap中有关元素浮动及清除浮动的class？

-   （1）`class="pull-left"` 元素浮动到左边
-   （2）`class="pull-right"` 元素浮动到右边
-   （3）`class="clearfix"` 清除浮动

#### [#](https://interview2.poetries.top/docs/base.html#_16-除了屏幕阅读器外-其他设备上隐藏元素的class)16 除了屏幕阅读器外，其他设备上隐藏元素的class？

>   `class="sr-only"``

#### [#](https://interview2.poetries.top/docs/base.html#_17-bootstrap如何制作下拉菜单)17 Bootstrap如何制作下拉菜单？
...
#### [#](https://interview2.poetries.top/docs/base.html#_18-bootstrap如何制作按钮组-以及水平按钮组和垂直按钮组的优先级)18 Bootstrap如何制作按钮组？以及水平按钮组和垂直按钮组的优先级？

-   （1）用`class="btn-group"`的`<div>`去包裹按钮组；`class="btn-group-vertical"`可设置垂直按钮组。
-   （2）`btn-group`的优先级高于`btn-group-vertical`的优先级。

#### [#](https://interview2.poetries.top/docs/base.html#_19-bootstrap如何设置按钮的下拉菜单)19 Bootstrap如何设置按钮的下拉菜单？

>   在一个 `.btn-group` 中放置按钮和下拉菜单即可。

#### [#](https://interview2.poetries.top/docs/base.html#_20-bootstrap中的输入框组如何制作)20 Bootstrap中的输入框组如何制作？
...
#### [#](https://interview2.poetries.top/docs/base.html#_21-bootstrap中的导航都有哪些)21 Bootstrap中的导航都有哪些？
...
#### [#](https://interview2.poetries.top/docs/base.html#_22-bootstrap中设置分页的class)22 Bootstrap中设置分页的class？

-   默认的分页：`class="pagination"`
-   默认的翻页：`class="pager"`

#### [#](https://interview2.poetries.top/docs/base.html#_23-bootstrap中显示标签的class)23 Bootstrap中显示标签的class？

>   ```
>   class="label"
>   ```

#### [#](https://interview2.poetries.top/docs/base.html#_24-bootstrap中如何制作徽章)24 Bootstrap中如何制作徽章？

>   ```
>   <span class="badge">26</span>
>   ```

#### [#](https://interview2.poetries.top/docs/base.html#_25-bootstrap中超大屏幕的作用是什么)25 Bootstrap中超大屏幕的作用是什么？
...
#### [#](https://interview2.poetries.top/docs/base.html#_5-微信小程序与vue区别)5 微信小程序与vue区别
